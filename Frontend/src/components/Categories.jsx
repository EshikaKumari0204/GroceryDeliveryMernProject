...
const Categories=()=>{
  ...
  return (
    ...
    {categories.map((category,index)=>(<div key={index} style={{ backgroundColor: `${category.bgColor}`}} className=" w-30 h-30 rounded-md flex flex-col justify-center items-center gap-1 hover:scale-105 transition  " onClick={()=>navigate(`products/${category.path.toLowerCase()}`)}>
